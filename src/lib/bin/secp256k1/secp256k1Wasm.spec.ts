...
// Proven combination success
// prettier-ignore
const combineEntry1 = new Uint8Array([0x03, 0xe3, 0xa4, 0x45, 0x41, 0xea, 0xc0, 0x25, 0x00, 0xaa, 0xe2, 0x6a, 0x3a, 0x22, 0x0a, 0xe3, 0x21, 0x70, 0xad, 0xa1, 0x0f, 0x0b, 0x08, 0xa1, 0x2e, 0xf4, 0x6e, 0x61, 0x4a, 0x35, 0x06, 0xc4, 0xb3]);

// prettier-ignore
const combineEntry2 = new Uint8Array([0x02, 0x95, 0x45, 0xbb, 0x2d, 0xe5, 0x0c, 0x88, 0x20, 0xd1, 0xa2, 0x2e, 0xad, 0xa3, 0x4a, 0xd1, 0x8a, 0xfe, 0x68, 0x34, 0xcd, 0x99, 0x3f, 0x2f, 0x35, 0x60, 0x3d, 0x03, 0xf0, 0x34, 0xd5, 0x77, 0x1d]);

// prettier-ignore
const combineResult = new Uint8Array([0xc1, 0x96, 0x8d, 0xc0, 0x2f, 0xcd, 0x50, 0x5f, 0x9d, 0x8b, 0xe1, 0x49, 0x60, 0x43, 0xa0, 0xba, 0x47, 0xcc, 0xeb, 0xbc, 0xf3, 0x6c, 0x08, 0x07, 0xb4, 0x73, 0x72, 0xb5, 0xd7, 0xe2, 0x41, 0xd2, 0xf4, 0xb2, 0xe0, 0xda, 0xcc, 0xee, 0x76, 0x9a, 0xe5, 0x24, 0x87, 0xe9, 0x95, 0xc2, 0xee, 0x1d, 0xe5, 0x3d, 0x19, 0x0d, 0xc7, 0x9b, 0x71, 0x18, 0x0a, 0xce, 0x3d, 0xea, 0x3a, 0x28, 0xf4, 0x76]);
...
const testSecp256k1Wasm = (
  ...
  const combineEntry1Ptr = secp256k1Wasm.mallocUint8Array(combineEntry1);
  const combineEntry2Ptr = secp256k1Wasm.mallocUint8Array(combineEntry2);

  const tab = new Uint32Array([combineEntry2Ptr, combineEntry1Ptr]);
  const tabPtr = secp256k1Wasm.mallocUint32Array(tab);
  ...
  t.deepEqual(
    secp256k1Wasm.readHeapU8(combineEntry1Ptr, 33),
    combineResult
  );
};
