import { bigIntToBinUint64LE, numberToBinUint32LE } from '../../../..';
 ...
 * @param scriptCode the script currently being executed, encoded as a
 * `scriptCode` (see BIP 143/Bitcoin Cash's Replay Protected Sighash spec.)
