...
import { binToHex, range } from '../../../utils';
...
testOperator(
  ...
  [
    {
      ...fullBase(),
      script: new Uint8Array([BitcoinCashOpCodes.OP_PUSHBYTES_5, 5, 10, 15, 20, 25])
    },
...
testOperator(
  ...
  [
    {
      ...fullBase(),
      script: new Uint8Array([BitcoinCashOpCodes.OP_PUSHBYTES_6, 5, 10, 15, 20, 25])
    },
    {
...
testOperator(
  ...
  [
    {
      ...fullBase(),
      script: new Uint8Array([BitcoinCashOpCodes.OP_PUSHDATA1, 100, 1, 2, 3])
    },
    {
      error: CommonAuthenticationError.malformedPush
    }
...
testOperator(
  ...
  [
    {
      ...fullBase(),
      script: new Uint8Array([BitcoinCashOpCodes.OP_PUSHDATA2, 1, 1, 1, 2, 3])
    },
    {
      error: CommonAuthenticationError.malformedPush
    }
